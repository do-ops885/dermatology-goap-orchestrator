 ...
 *
 * Run this in browser console to measure Web Vitals
 *
 * Usage:
...
(function () {
  ...
  console.warn('Interact with app to collect metrics...\n');
  ...
  if (typeof window.webVitals !== 'undefined') {
    ...
    window.webVitals.onFID(logMetric);
    window.webVitals.onFCP(logMetric);
    window.webVitals.onLCP(logMetric);
    window.webVitals.onTTFB(logMetric);
