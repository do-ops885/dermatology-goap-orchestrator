...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        "connect-src 'self' ws://localhost:5173 wss://localhost:5173 https://esm.sh https://generativelanguage.googleapis.com https://storage.googleapis.com https://huggingface.co https://raw.githubusercontent.com blob: data:",
  ...
  resolve: {
    alias: {
      ...
      process: path.resolve(__dirname, './stubs/process.js'),
    ...
    rollupOptions: {
      ...
      output: {
        manualChunks: {
          ...
          'vendor-utils': ['lucide-react', 'buffer'],
        },
      },
    },
