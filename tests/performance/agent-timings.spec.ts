...
async function detectSkinTone(_image: HTMLCanvasElement): Promise<{ tone: string; confidence: number }> {
...
async function generateRecommendations(_data: { risk: string; conditions: unknown[] }): Promise<string[]> {
