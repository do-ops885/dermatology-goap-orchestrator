...
describe('DiagnosticSummary Web Verification', () => {
  ...
  it('truncates summary to 150 characters', () => {
    const longSummary =
      'This is a very long summary text that should exceed the 150 character limit and therefore be truncated with ellipsis when displayed in the web verification section of the diagnostic summary component.';
