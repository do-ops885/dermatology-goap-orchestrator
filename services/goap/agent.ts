...
import { AgentHandoffCoordinator } from './handoffCoordinator';

import type { AgentAction, WorldState } from '../../types';
import type { AgentContext, ExecutorResult } from '../executors/types';
...
export class GoapAgent {
  ...
  private async executeAgent(
    ...
    currentState = this.handoffCoordinator.autoCorrectState(currentState, action.agentId);
